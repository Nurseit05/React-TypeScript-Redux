...
export const User = ({id, first_name, last_name, avatar, email, onClickInvites, isInvites}) => (
  <li>
    <div>
    ...
    <img onClick={() => onClickInvites(id)} className="action" src={`/assets/${isInvites ? 'minus' :'plus' }.svg`} alt="Action" />
  </li>
);
